...
if(!$edit = User::find_by_id($_GET['id']))
{
    redirect("../");
}
...
if(isset($_POST['submit']))
{
    ...
    if(!User::user_exists($email) || $email == $edit->email)
    {
        $edit->name = $name;
        $edit->school = $school;
        $edit->email = $email;
        
        if($edit->save($edit->id))
        {
                                ...
                                <div class="col-auto mt-4">
                                    <a class="btn btn-white text-primary mb-5" href="../">
                                        < Prapa</a> <h1 class="page-header-title">
                                            <div class="page-header-icon mr-3"><i data-feather="edit-3"></i></div>
                                            <?php echo $edit->school ?>
                                            </h1>
                                            <div class="page-header-subtitle">Ndrysho te dhenat e DKA-së: <?php echo $edit->school ?></div>
                                    ...
                                    <div class="card col-lg-6 ml-5 mb-5 p-0" >
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php if(isset($msg)) : ?>
                                                ...
                                                <label for="name" class="col-form-label">Emri i pergjegjesit</label>
                                                <input id="name" type="text" required name='name' class="form-control" value="<?php echo isset($_POST['name']) ? $_POST['name'] : $edit->name ?>">

                                                <?php if($edit->type == 1) : ?>
                                                    <label for="school" class="col-form-label">Emri i komunes</label>
                                                    <input id="school" type="text" required name='school' class="form-control" value="<?php echo isset($_POST['school']) ? $_POST['school'] : $edit->school ?>">
                                                <?php elseif($edit->type == 2) : ?>
                                                ...
                                                <input id="email" type="email" required name='email' class="form-control" value="<?php echo isset($_POST['email']) ? $_POST['email'] : $edit->email ?>">
